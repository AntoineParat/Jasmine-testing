...
$(function() {
    ...
    */
    ...
    describe('The menu', function() {
        ...
        /* First test ensures the menu element is
        ...
        it ('menu is hidden by default', function () {
         ...
         /* Second test ensures the menu changes
    ...
    /* This is our last test suite named "New Feed Selection" */
    describe ('New Feed Selection', function () {  
        ...
        beforeEach(function (done) {
            loadFeed(0,function() { 
                currentTitle = document.querySelector(".entry h2").innerHTML;  
                loadFeed(1,function() { 
                    newTitle = document.querySelector(".entry h2").innerHTML; 
                    done();
                });
            });            
        });
        ...
        it ("content actually changes", function () {
           expect(currentTitle).not.toEqual(newTitle);
         });  
    });
}());
